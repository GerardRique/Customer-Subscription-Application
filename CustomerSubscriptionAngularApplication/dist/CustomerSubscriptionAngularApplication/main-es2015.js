...
let ServiceListComponent = class ServiceListComponent {
    ...
    ngOnInit() {
        let result = this.http.get(_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilsService"].API_URL + "/service");
        result.subscribe((response) => {
            console.log(response);
            if (response['status'] === 200) {
                this.services = response['services'];
...
let SubscribeServiceComponent = class SubscribeServiceComponent {
    ...
    unsubscribe(serviceId) {
        ...
        this.http.post(_utils_service__WEBPACK_IMPORTED_MODULE_5__["UtilsService"].API_URL + "/unsubscribe", postData).subscribe((response) => {
            console.log(response);
            if (response['status'] === 200) {
    ...
    displaySuccessfullAlert(message) {
        const toast = sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
